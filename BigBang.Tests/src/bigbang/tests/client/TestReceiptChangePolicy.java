...
public class TestReceiptChangePolicy
{
	...
	private static void DoStep1()
	{
		...
		parameter.freeText = "A123";

		Services.receiptService.openSearch(new SearchParameter[] {parameter}, new SortParameter[] {}, 5, callback);
	}
