...
public class TestNegotiationEdit
{
	...
	private static void DoStep3(Negotiation negotiation)
	{
		AsyncCallback<Negotiation> callback = new AsyncCallback<Negotiation>()
		{
			public void onFailure(Throwable caught)
		...
		negotiation.notes = "Notas diferentes das anteriores";
		Services.negotiationService.editNegotiation(negotiation, callback);
	}
