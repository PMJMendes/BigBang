...
public class ContactView_OLD extends View implements ContactsBrokerClient {
	...
	public ContactView_OLD(){
		...
		infoEntries = new ArrayList<ContactView_OLD.InfoEntry>();
		...
		this.addAttachHandler(new AttachEvent.Handler() {
			...
			public void onAttachOrDetach(AttachEvent event) {
				if(event.isAttached()){
					ContactView_OLD.this.childContactsButton.setSelected(false);
				}
			}
		});
	...
	protected void fireAction(Action action){
		if(this.actionHandler != null) {
			actionHandler.onActionInvoked(new ActionInvokedEvent<ContactView_OLD.Action>(action));
		}
	}
