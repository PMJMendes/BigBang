...
public class TaxesAndMultipliersManagementOperation implements Operation {

	public static final String ID = "TAXES_MANAGEMENT_OPERATION";
	public static final String DESCRIPTION = "Gestão de impostos e coeficientes";
	public static final String SHORT_DESCRIPTION = "Impostos";
