...
import bigBang.module.insurancePolicyModule.client.InsurancePolicySection;

public class InsurancePolicySectionViewPresenter implements SectionViewPresenter{
	...
	private InsurancePolicySection insurancePolicySection;
	...
	public InsurancePolicySectionViewPresenter(EventBus eventBus, Service service, View view) {
	...
	public void setSection(MenuSection s) {
		this.insurancePolicySection = (InsurancePolicySection) s;
		OperationViewPresenter[] operationPresenters = this.insurancePolicySection.getOperationPresenters();
		for(int i = 0; i < operationPresenters.length; i++)
			registerOperation(operationPresenters[i]);
	}
	
	public MenuSection getSection() {
		return this.insurancePolicySection;
	}
