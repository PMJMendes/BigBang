insert into credite_egs.tblBBExpenses (PK, ENumber, FKProcess, ExpenseDate, FKPolicyObject, FKSubPolicyObject, FKPolicyCoverage, Damages, Settlement, BManual, Notes, Rejection)
