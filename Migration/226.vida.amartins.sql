...
(select ItemValue from amartins.tblPolicyValueItems where FKTaxAsSubList='104753F0-15E5-437B-9223-A06E00E6BF68');
...
where 'Constante' not in
(select ItemValue from amartins.tblPolicyValueItems where FKTaxAsSubList='D455F2AD-F045-42EC-9441-9F9601739A10');
