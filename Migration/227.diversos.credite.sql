...
from credegs..empresa.apolice s
inner join credite_egs.tblBBPolicies p on p.MigrationID=s.MigrationID
inner join credegs..empresa.objectos o on o.cliente=s.cliente and o.apolice=s.apolice and o.comseg=s.comseg and o.ramo=s.ramo
...
inner join credegs..empresa.objectos ox on ox.cliente=s.cliente and ox.apolice=s.apolice and ox.comseg=s.comseg and ox.ramo=s.ramo
