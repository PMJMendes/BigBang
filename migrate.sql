...
insert into bigbang.tblUsers (PK, FullName, Username, FKProfile) values ('091B8442-B7B0-40FA-B517-9EB00068A390', N'Administrator', N'root', '061388D9-16A6-443F-A69E-9EB000685026');
...
insert into bigbang.tblLineCategories (PK, LineCatName) values ('2442DD02-F525-4CE3-9CFF-9EE9010ABC44', N'Responsabilidade Civil');
...
insert into bigbang.tblBBLines (PK, LineName, FKCategory) values ('CF483414-189C-4A0A-998B-9EE901132980', N'Cascos', '00960D0F-F31F-4A9E-AE7E-9EE9010AD157');
...
insert into bigbang.tblBBLines (PK, LineName, FKCategory) values ('BF120673-DD11-495F-A9F2-9EE901133DA4', N'Responsabilidade Civil', '00960D0F-F31F-4A9E-AE7E-9EE9010AD157');
...
insert into bigbang.tblBBLines (PK, LineName, FKCategory) values ('88B63B22-3BD7-4391-9C69-9EE901135CF9', N'Cascos', '370DE151-6ABF-4561-A8BD-9EE9010ADC2A');
...
insert into bigbang.tblBBLines (PK, LineName, FKCategory) values ('FE8633FB-7A46-4DE4-89E4-9EE90113736E', N'Responsabilidade Civil', '370DE151-6ABF-4561-A8BD-9EE9010ADC2A');
insert into bigbang.tblBBLines (PK, LineName, FKCategory) values ('89344125-0CDB-4242-BF23-9EE901138254', N'Cascos', 'C81B00E0-1BC2-48E6-B8FE-9EE9010AE3A2');
insert into bigbang.tblBBLines (PK, LineName, FKCategory) values ('808536C0-D5FB-4049-B79A-9EE901138B69', N'Responsabilidade Civil', 'C81B00E0-1BC2-48E6-B8FE-9EE9010AE3A2');
...
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('1B70989B-1D54-408E-BDF7-9EE90119749F', N'Misto', '9F56581A-64B9-4D8E-B3CD-9EE9010E63D5');
...
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('D2ACD7C9-C5A6-42A8-9E11-9EE9011987D0', N'Misto', '15A5E5BF-F045-4AF9-BF4B-9EE9010E6B40');
...
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('445184E3-326B-4796-8618-9EE9011A5811', N'Única', '172CFFAF-AF5B-4E3E-980E-9EE901114D02');
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('D36F47AB-0D5A-425D-8FD4-9EE9011A6837', N'Única', '211BF6E2-9255-4FF1-89AD-9EE9011167D0');
...
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('D6B6557C-B6E3-4729-B3E7-9EE9011B281E', N'Única', 'BF120673-DD11-495F-A9F2-9EE901133DA4');
...
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('4FB13E79-5F93-4ECD-8377-9EE9011B4A4E', N'Única', 'FE8633FB-7A46-4DE4-89E4-9EE90113736E');
...
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('6C5696AC-02F2-4124-BC5A-9EE9011B5E5F', N'Única', '808536C0-D5FB-4049-B79A-9EE901138B69');
...
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('5B47E55C-0EDD-4B31-8D4A-9EE9011B75C6', N'Única', '88DBC911-336B-4098-A0B7-9EE90113BD32');
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('EB9E9AAA-A33B-4D75-B3FF-9EE9011B7A0A', N'Única', '99967F7A-ADAF-4E8D-915A-9EE90113C66D');
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('A56384EE-3F17-42E7-9B2C-9EE9011B7DC7', N'Única', '3A0110CA-7136-4499-ABCE-9EE90113CF24');
...
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('F4333BC2-A0DB-4CD2-8FB2-9EE9011BBCAC', N'Capitalização', 'FDE37FD5-BD29-4AA6-8A30-9EE901151B11');
...
insert into bigbang.tblBBSubLines (PK, SubLineName, FKLine) values ('C304BE3B-7B80-412A-B277-9EE9011BFB56', N'Capitalização', 'F4E19A84-44FD-4BCE-9EDE-9EE9011521C0');
