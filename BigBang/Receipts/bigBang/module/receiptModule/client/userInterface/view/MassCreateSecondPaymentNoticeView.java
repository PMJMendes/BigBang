...
public class MassCreateSecondPaymentNoticeView extends View implements MassCreateSecondPaymentNoticeViewPresenter.Display{
	...
	protected static class CheckableReceiptsSearchPanel extends CheckableSearchPanel<ReceiptStub>{
		...
		public CheckableReceiptsSearchPanel(){
			...
			this.setOperationId(BigBangConstants.OperationIds.ReceiptProcess.CREATE_SECOND_PAYMENT_NOTICE);
	...
	protected ActionInvokedEventHandler<MassCreateSecondPaymentNoticeViewPresenter.Action> actionHandler;
	...
	public MassCreateSecondPaymentNoticeView(){
		...
		Button selectAllButton = new Button("Seleccionar Todos", new ClickHandler() {
			...
			@Override
			public void onClick(ClickEvent event) {
				actionHandler.onActionInvoked(new ActionInvokedEvent<MassCreateSecondPaymentNoticeViewPresenter.Action>(MassCreateSecondPaymentNoticeViewPresenter.Action.SELECT_ALL));
			}
		});
		...
		createPNotice = new Button("Criar Segundos Avisos de Cobrança");
		...
		createPNotice.addClickHandler(new ClickHandler() {
			...
			@Override
			public void onClick(ClickEvent event) {
				actionHandler.onActionInvoked(new ActionInvokedEvent<MassCreateSecondPaymentNoticeViewPresenter.Action>(MassCreateSecondPaymentNoticeViewPresenter.Action.CREATE_SECOND_PAYMENT_NOTICES));
			}
		});
		...
		applyPaymentNoticeCreationForm.addSection("Criar Segundos Avisos de Cobrança");


		VerticalPanel selectedListWrapper = new VerticalPanel();
		selectedListWrapper.add(new ListHeader("Criar Segundos Avisos de Cobrança"));
		...
		clearButton.addClickHandler(new ClickHandler() {
			...
			@Override
			public void onClick(ClickEvent event) {
				actionHandler.onActionInvoked(new ActionInvokedEvent<MassCreateSecondPaymentNoticeViewPresenter.Action>(MassCreateSecondPaymentNoticeViewPresenter.Action.CLEAR));
			}
		});
	...
	public void registerActionHandler(
			ActionInvokedEventHandler<MassCreateSecondPaymentNoticeViewPresenter.Action> actionInvokedEventHandler) {
