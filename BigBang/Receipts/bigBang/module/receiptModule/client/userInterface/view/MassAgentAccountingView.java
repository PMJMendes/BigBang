...
import bigBang.module.receiptModule.client.userInterface.presenter.MassAgentAccountingViewPresenter.Action;
...
public class MassAgentAccountingView extends View implements MassAgentAccountingViewPresenter.Display{
	...
	public MassAgentAccountingView(){
		...
		createPNotice.addClickHandler(new ClickHandler() {
			...
			@Override
			public void onClick(ClickEvent event) {
				actionHandler.onActionInvoked(new ActionInvokedEvent<Action>(Action.SEND_AGENT_ACCOUNTING));
			}
		});
