...
public class SerialMarkForPaymentView extends View implements SerialMarkForPaymentViewPresenter.Display {
	...
	public SerialMarkForPaymentView(){
		...
		searchPanel.setOperationId(BigBangConstants.OperationIds.ReceiptProcess.MARK_FOR_PAYMENT);
		listWrapper.add(searchPanel);
		listWrapper.setCellHeight(searchPanel, "100%");
