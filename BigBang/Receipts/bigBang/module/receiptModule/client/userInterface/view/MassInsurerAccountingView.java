...
import bigBang.module.receiptModule.client.userInterface.form.InsurerAccountingExtraForm;
...
import bigBang.module.receiptModule.client.userInterface.presenter.MassInsurerAccountingViewPresenter.Action;
...
public class MassInsurerAccountingView extends View implements MassInsurerAccountingViewPresenter.Display{
	...
	public MassInsurerAccountingView(){
		...
		createPNotice.addClickHandler(new ClickHandler() {
			...
			@Override
			public void onClick(ClickEvent event) {
				actionHandler.onActionInvoked(new ActionInvokedEvent<Action>(Action.SEND_INSURER_ACCOUNTING));
			}
		});
	...
	@Override 
	public void addReceiptToAccountingList(ReceiptStub value) {
		this.selectedReceipts.addEntry(value);
		searchPanel.markForCheck(value.id);
	}

	@Override
	public void removeReceiptFromAccountingList(String id){
	...
	@Override
	public void removeAllReceiptsFromAccountingList() {
