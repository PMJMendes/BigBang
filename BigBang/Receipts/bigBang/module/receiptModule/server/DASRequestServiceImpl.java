...
import com.premiumminds.BigBang.Jewel.Operations.DASRequest.CancelRequest;
import com.premiumminds.BigBang.Jewel.Operations.DASRequest.ReceiveReply;
import com.premiumminds.BigBang.Jewel.Operations.DASRequest.RepeatRequest;

public class DASRequestServiceImpl
	extends EngineImplementor
	implements DASRequestService
{
	private static final long serialVersionUID = 1L;

	public static DASRequest sGetRequest(UUID pid)
		throws BigBangException
	{
		com.premiumminds.BigBang.Jewel.Objects.DASRequest lobjRequest;
		IProcess lobjProcess;
		UUID lidReceipt;
//		RequestAddress[] larrAddresses;
		DASRequest lobjResult;
...
//		int i;
		...
		try
		{
			lobjRequest = com.premiumminds.BigBang.Jewel.Objects.DASRequest.GetInstance(Engine.getCurrentNameSpace(), pid);
...
//		lobjResult.message.text = lobjRequest.getText();
	...
	public DASRequest getRequest(String id)
	...
	public DASRequest repeatRequest(DASRequest request)
		throws SessionExpiredException, BigBangException
	{
		com.premiumminds.BigBang.Jewel.Objects.DASRequest lobjRequest;
		RepeatRequest lopRR;
		...
		try
		{
			lobjRequest = com.premiumminds.BigBang.Jewel.Objects.DASRequest.GetInstance(Engine.getCurrentNameSpace(),
	...
	public DASRequest receiveResponse(DASRequest.Response response)
		throws SessionExpiredException, BigBangException
	{
		com.premiumminds.BigBang.Jewel.Objects.DASRequest lobjRequest;
		ReceiveReply lopRR;
...
//					PNProcess.GetInstance(Engine.getCurrentNameSpace(), lobjRequest.GetProcessID()).GetScript().GetDataType());
	...
	public void cancelRequest(DASRequest.Cancellation cancellation)
		throws SessionExpiredException, BigBangException
	{
		com.premiumminds.BigBang.Jewel.Objects.DASRequest lobjRequest;
		CancelRequest lopCR;
