...
public class DragClientBundle_default_StaticClientBundleGenerator implements com.allen_sauer.gwt.dnd.client.util.DragClientBundle {
  ...
  private void _init0() {
    ...
    public String getText() {
      return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? (("HTML{margin:" + ("0")  + " !important;border:" + ("none")  + " !important;}.dragdrop-handle{cursor:" + ("move")  + ";user-select:" + ("none")  + ";-khtml-user-select:" + ("none")  + ";-moz-user-select:" + ("none")  + ";}.GFOE1RNDB{zoom:" + ("1")  + ";}.dragdrop-dragging{zoom:" + ("normal")  + ";}.GFOE1RNDI{border:" + ("1px"+ " " +"dashed"+ " " +"#1e90ff")  + ";margin:" + ("0")  + " !important;zoom:") + (("1")  + ";z-index:" + ("100")  + ";}.dragdrop-flow-panel-positioner{color:" + ("#1e90ff")  + ";display:" + ("inline")  + ";text-align:" + ("center")  + ";vertical-align:" + ("middle")  + ";}.dragdrop-proxy{background-color:" + ("#7af")  + ";}.dragdrop-selected,.dragdrop-dragging,.dragdrop-proxy{filter:" + ("alpha(opacity\\=30)")  + ";opacity:" + ("0.3")  + ";}.dragdrop-movable-panel{z-index:" + ("200")  + ";margin:" + ("0") ) + (" !important;border:" + ("none")  + " !important;}")) : (("HTML{margin:" + ("0")  + " !important;border:" + ("none")  + " !important;}.dragdrop-handle{cursor:" + ("move")  + ";user-select:" + ("none")  + ";-khtml-user-select:" + ("none")  + ";-moz-user-select:" + ("none")  + ";}.GFOE1RNDB{zoom:" + ("1")  + ";}.dragdrop-dragging{zoom:" + ("normal")  + ";}.GFOE1RNDI{border:" + ("1px"+ " " +"dashed"+ " " +"#1e90ff")  + ";margin:" + ("0")  + " !important;zoom:") + (("1")  + ";z-index:" + ("100")  + ";}.dragdrop-flow-panel-positioner{color:" + ("#1e90ff")  + ";display:" + ("inline")  + ";text-align:" + ("center")  + ";vertical-align:" + ("middle")  + ";}.dragdrop-proxy{background-color:" + ("#7af")  + ";}.dragdrop-selected,.dragdrop-dragging,.dragdrop-proxy{filter:" + ("alpha(opacity\\=30)")  + ";opacity:" + ("0.3")  + ";}.dragdrop-movable-panel{z-index:" + ("200")  + ";margin:" + ("0") ) + (" !important;border:" + ("none")  + " !important;}"));
    }
  ...
  static {
    new DragClientBundle_default_StaticClientBundleGenerator()._init0();
  }
