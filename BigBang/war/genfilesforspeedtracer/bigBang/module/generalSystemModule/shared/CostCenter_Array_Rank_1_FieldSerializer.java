...
public class CostCenter_Array_Rank_1_FieldSerializer {
  public static class Handler implements com.google.gwt.user.client.rpc.impl.TypeHandler {
    public void deserialize(SerializationStreamReader reader, Object object) throws SerializationException {
      bigBang.module.generalSystemModule.shared.CostCenter_Array_Rank_1_FieldSerializer.deserialize(reader, (bigBang.module.generalSystemModule.shared.CostCenter[])object);
    }
    public Object instantiate(SerializationStreamReader reader) throws SerializationException {
      return bigBang.module.generalSystemModule.shared.CostCenter_Array_Rank_1_FieldSerializer.instantiate(reader);
    }
    public void serialize(SerializationStreamWriter writer, Object object) throws SerializationException {
      bigBang.module.generalSystemModule.shared.CostCenter_Array_Rank_1_FieldSerializer.serialize(writer, (bigBang.module.generalSystemModule.shared.CostCenter[])object);
    }
  }
  ...
  public static bigBang.module.generalSystemModule.shared.CostCenter[] instantiate(SerializationStreamReader streamReader) throws SerializationException {
    ...
    return new bigBang.module.generalSystemModule.shared.CostCenter[size];
  }
