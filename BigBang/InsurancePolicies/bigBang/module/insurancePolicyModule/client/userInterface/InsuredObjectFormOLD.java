...
public class InsuredObjectFormOLD extends FormView<InsuredObjectOLD> {
	...
	public InsuredObjectFormOLD(){
		...
		this.dynamicFixedHeaderFields = new ArrayList<InsuredObjectFormOLD.DynFormField>();
