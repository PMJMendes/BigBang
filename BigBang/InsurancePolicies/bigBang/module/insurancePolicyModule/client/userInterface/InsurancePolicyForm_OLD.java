...
public abstract class InsurancePolicyForm_OLD extends FormView<InsurancePolicy> {	
	...
	public InsurancePolicyForm_OLD(){
		super();
			...
			if(info.clientId != null) {
				...
				clientBroker.getClient(info.clientId, new ResponseHandler<Client>() {
					...
					public void onResponse(Client response) {
						...
						InsurancePolicyForm_OLD.this.client.setValue(item);

						InsurancePolicyForm_OLD.this.client.setValueName("#" + response.clientNumber + " - " + response.name);
					}
