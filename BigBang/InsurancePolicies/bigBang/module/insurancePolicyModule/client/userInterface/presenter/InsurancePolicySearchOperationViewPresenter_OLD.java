...
public class InsurancePolicySearchOperationViewPresenter_OLD implements
ViewPresenter {
	...
	public InsurancePolicySearchOperationViewPresenter_OLD(Display view){
	...
	public void bind() {
		...
		this.view.registerActionInvokedHandler(new ActionInvokedEventHandler<InsurancePolicySearchOperationViewPresenter_OLD.Action>() {
