...
public class InsurancePolicyCompanyInfoRequestViewPresenter extends InfoOrDocumentRequestViewPresenter<Policy2>{

	private InsurancePolicyBroker broker;

	public InsurancePolicyCompanyInfoRequestViewPresenter(Display<Policy2> view) {
		super(view);
