...
public class InsurancePolicySubCasualtyList extends FilterableList<SubCasualtyStub> implements SubCasualtyDataBrokerClient
{
	...
	public InsurancePolicySubCasualtyList()
	{
	...
	public void setOwner(String ownerId)
	{
		...
		{
			broker.getLiveSubCasualtiesForPolicy(ownerId, new ResponseHandler<Collection<SubCasualtyStub>>()
			{
				@Override
