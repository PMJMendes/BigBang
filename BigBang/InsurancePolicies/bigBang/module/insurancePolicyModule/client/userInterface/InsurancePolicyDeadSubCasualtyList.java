...
public class InsurancePolicyDeadSubCasualtyList extends FilterableList<SubCasualtyStub> implements SubCasualtyDataBrokerClient
{
	...
	public InsurancePolicyDeadSubCasualtyList()
	{
	...
	public void setOwner(String ownerId)
	{
		...
		{
			broker.getDeadSubCasualtiesForPolicy(ownerId, new ResponseHandler<Collection<SubCasualtyStub>>()
			{
				@Override
