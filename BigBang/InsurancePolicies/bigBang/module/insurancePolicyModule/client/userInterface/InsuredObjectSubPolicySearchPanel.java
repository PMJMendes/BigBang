...
public class InsuredObjectSubPolicySearchPanel extends SearchPanel<InsuredObjectStub> implements InsuredObjectDataBrokerClient{
	...
	public InsuredObjectSubPolicySearchPanel() { 
		super(((InsuredObjectDataBroker)DataBrokerManager.Util.getInstance().getBroker(BigBangConstants.EntityIds.INSURANCE_SUB_POLICY_INSURED_OBJECTS)).getSearchBroker());
