...
import bigBang.module.insurancePolicyModule.client.userInterface.presenter.InsurancePolicySearchOperationViewPresenter_OLD;
import bigBang.module.insurancePolicyModule.client.userInterface.presenter.InsurancePolicySearchOperationViewPresenter_OLD.Action;
...
public class InsurancePolicySearchOperationView_OLD extends View implements InsurancePolicySearchOperationViewPresenter_OLD.Display {
	...
	public InsurancePolicySearchOperationView_OLD(){
		...
		searchPanel = new InsurancePolicySearchPanel(){
			...
			public void onResults(Collection<InsurancePolicyStub> results) {
				...
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.ON_NEW_RESULTS));
			}
		};
		...
		toolbar = new InsurancePolicyOperationsToolBar_OLD(){

			@Override
			public void onVoidPolicy() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.VOID_POLICY));
			}

			@Override
			public void onBrokerageTransfer() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.TRANSFER_BROKERAGE));
			}

			@Override
			public void onDelete() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.DELETE));
			}
			
			@Override
			public void onValidate() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.VALIDATE));
			}

			@Override
			public void onCreateSubstitutePolicy() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.CREATE_SUBSTITUTE_POLICY));
			}

			@Override
			public void onRequestInfoFromClient() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.REQUEST_CLIENT_INFO));
			}

			@Override
			public void onRequestInfoFromAgency() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.REQUEST_AGENCY_INFO));
			}

			@Override
			public void onCreateInsuredObject() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.CREATE_INSURED_OBJECT));
			}
			
			@Override
			public void onIncludeInsuredObject() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.INCLUDE_INSURED_OBJECT));
			}
			
			@Override
			public void onCreateExercise() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.CREATE_EXERCISE));
			}

			@Override
			public void onCreateInsuredObjectFromClient() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.CREATE_INSURED_OBJECT_FROM_CLIENT));
			}

			@Override
			public void onCreateManagerTransfer() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.TRANSFER_MANAGER));
			}

			@Override
			public void onExecuteDecailedCalculations() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.EXECUTE_DETAILED_CALCULATIONS));
			}

			@Override
			public void onCreateInfoManagementProcess() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.CREATE_INFO_MANAGEMENT_PROCESS));
			}

			@Override
			public void onCreateSubPolicy() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.CREATE_SUB_POLICY));
			}

			@Override
			public void onIssueDebitNote() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.ISSUE_DEBIT_NOTE));
			}

			@Override
			public void onCreateNegotiation() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.CREATE_NEGOTIATION));
			}

			@Override
			public void onCreateHealthExpense() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.CREATE_EXPENSE));
			}

			@Override
			public void onCreateRiskAnalysis() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.CREATE_RISK_ANALISYS));
			}

			@Override
			public void onCreateReceipt() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.CREATE_RECEIPT));
			}

			@Override
			public void onEditRequest() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.EDIT));
			}

			@Override
			public void onSaveRequest() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.SAVE));
			}

			@Override
			public void onCancelRequest() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.CANCEL_EDIT));
			}

			@Override
			public void onTransferToClient() {
				actionHandler.onActionInvoked(new ActionInvokedEvent<InsurancePolicySearchOperationViewPresenter_OLD.Action>(Action.TRANSFER_TO_CLIENT));
