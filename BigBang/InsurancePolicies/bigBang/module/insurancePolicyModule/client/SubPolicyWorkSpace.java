...
public class SubPolicyWorkSpace {
	...
	public SubPolicy getWholeSubPolicy(String subPolicyId) {
		...
		{
			for ( ComplexFieldContainer.ExerciseData exercise : originalSubPolicy.exerciseData )
	...
	public ComplexFieldContainer.ExerciseData[] getExercises(String subPolicyId) {
		if ( !isSubPolicyLoaded(subPolicyId) )
			return null;
	...
	public InsuredObject loadExistingObject(String subPolicyId, InsuredObject object) {
		...
		try {
			newObject.headerFields = mergeHeaderArrays(new FieldContainer.HeaderField[][] {subPolicy.headerFields, object.headerFields},
	...
	public InsuredObject createLocalObject(String subPolicyId) {
		...
		try {
			newObject.headerFields = mergeHeaderArrays(new FieldContainer.HeaderField[][] {subPolicy.headerFields, newObject.headerFields},
					new boolean[] {true, false});
		} catch (Exception e) {
			return null;
		}
