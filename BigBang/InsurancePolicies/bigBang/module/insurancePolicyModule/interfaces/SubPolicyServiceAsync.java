	...
	extends SearchServiceAsync, DependentItemSubServiceAsync
{
	...
	void createObjectInPad(String subPolicyId, AsyncCallback<InsuredObjectOLD> callback);
	void createObjectFromClientInPad(String subPolicyId, AsyncCallback<InsuredObjectOLD> callback);
	...
	void includeObject(String subPolicyId, InsuredObjectOLD object, AsyncCallback<InsuredObjectOLD> callback);
	void includeObjectFromClient(String subPolicyId, AsyncCallback<InsuredObjectOLD> callback);
