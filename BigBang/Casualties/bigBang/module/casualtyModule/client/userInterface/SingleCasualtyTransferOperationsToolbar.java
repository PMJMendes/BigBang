...
public abstract class SingleCasualtyTransferOperationsToolbar extends
		BigBangOperationsToolBar {

	private MenuItem transferItem;
	private MenuItem cancelItem;
	
	public SingleCasualtyTransferOperationsToolbar(){
		hideAll();
		this.transferItem = new MenuItem("Transferir Sinistro", new Command() {
