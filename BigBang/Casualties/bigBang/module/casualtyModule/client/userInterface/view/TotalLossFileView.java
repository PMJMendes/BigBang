...
import bigBang.module.casualtyModule.client.userInterface.presenter.TotalLossFileViewPresenter.Action;


public class TotalLossFileView extends View implements TotalLossFileViewPresenter.Display{

	protected TotalLossFileForm form;
	...
	@Override
	public HasEditableValue<TotalLossFile> getForm() {
		return form;
	}
