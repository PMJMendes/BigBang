...
import bigBang.module.casualtyModule.client.userInterface.presenter.SubCasualtyCreateReceiptViewPresenter.Action;
...
public class SubCasualtyCreateReceiptView extends View implements SubCasualtyCreateReceiptViewPresenter.Display {
	...
	public SubCasualtyCreateReceiptView(){
		...
		this.toolbar = new BigBangOperationsToolBar(){
			...
			public void onSaveRequest() {
				handler.onActionInvoked(new ActionInvokedEvent<SubCasualtyCreateReceiptViewPresenter.Action>(Action.SAVE));
			}

			@Override
			public void onCancelRequest() {
				handler.onActionInvoked(new ActionInvokedEvent<SubCasualtyCreateReceiptViewPresenter.Action>(Action.CANCEL));
			}
		};
		toolbar.hideAll();
	...
	@Override
	public HasValue<SubCasualty> getParentForm() {
