...
/**
 * This class has "all" the code from the old TextAreaFormField, without the limitation for 
 * a max 250 characters. It is expanded by TextAreaFormField's class. *
 */
public class UnlimitedTextAreaFormField extends FormField<String> {
	...
	public UnlimitedTextAreaFormField(String label,FieldValidator<String> validator){
		this();
		setLabel(label);
		setValidator(validator);
	}

	public UnlimitedTextAreaFormField(FieldValidator<String> validator) {
		this();
		setValidator(validator);
	}

	public UnlimitedTextAreaFormField(String label) {
		this();
		setLabel(label);
	}
	...
	public UnlimitedTextAreaFormField(){
		super();
