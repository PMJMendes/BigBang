...
public class MediatorForm extends FormView<Mediator> {
	...
	protected ExpandableListBoxFormField comissionProfile;
	protected NumericTextBoxFormField commissionPercentage;
	...
	public MediatorForm() {
		...
		setValidator(new MediatorFormValidator(this));
	}
