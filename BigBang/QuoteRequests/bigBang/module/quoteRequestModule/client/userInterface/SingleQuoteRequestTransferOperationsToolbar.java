...
public abstract class SingleQuoteRequestTransferOperationsToolbar extends
		BigBangOperationsToolBar {

	private MenuItem transferItem;
	private MenuItem cancelItem;
	
	public SingleQuoteRequestTransferOperationsToolbar(){
		hideAll();
		this.transferItem = new MenuItem("Transferir Consulta de Mercado", new Command() {
