...
public class QuoteRequestObjectSubLineSectionTable extends TwoKeyTableView {

//	protected Coverage[] coverages;
//	protected Map<HasValue<String>, String> coverageRadioButtons;
//
//	public QuoteRequestObjectSubLineSectionTable(){
//		super();
...
//					String present = coverages[i-1].presentInRequestSubLine == null ? null : (coverages[i-1].presentInRequestSubLine ? "1" : "0");
...
//					coverage.presentInRequestSubLine = radio.getValue() == null ? null : radio.getValue().equals("1") ? true : false;
//					break;
//				}
//			}
//		}
