...
//SendMessageViewPresenter<QuoteRequest> {
//
...
//
//	@Override
//	protected void fillContacts(String ownerId,
//			final ResponseHandler<Boolean> handler) {
//		broker.getQuoteRequest(ownerId, new ResponseHandler<QuoteRequest>() {
//
//			@Override
//			public void onResponse(QuoteRequest response) {
//				//TODO REQUESTS 	handler.onResponse(PermissionChecker.hasPermission(response, BigBangConstants.OperationIds.QuoteRequestProcess.CREATE_INFO_OR_DOCUMENT_REQUEST));
//			}
//
//			@Override
//			public void onError(Collection<ResponseError> errors) {
