...
public class ClientCasualtyList extends FilterableList<CasualtyStub> implements CasualtyDataBrokerClient {
	...
	public void setOwner(String ownerId){
		...
		if(ownerId != null){
			...
			broker.getCasualtiesForClient(ownerId, new ResponseHandler<Collection<CasualtyStub>>() {
