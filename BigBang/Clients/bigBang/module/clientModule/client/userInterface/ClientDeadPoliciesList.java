...
public class ClientDeadPoliciesList extends FilterableList<InsurancePolicyStub> implements InsurancePolicyDataBrokerClient{
	...
	public void setOwner(String ownerId){
		...
		if(ownerId != null){
			...
			broker.getDeadClientPolicies(ownerId, new ResponseHandler<Collection<InsurancePolicyStub>>() {

				@Override
				public void onResponse(Collection<InsurancePolicyStub> response) {
					ClientDeadPoliciesList.this.clear();
