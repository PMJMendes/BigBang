...
public class OOConnector
{
	public static XTextDocument getDocFromBytes(byte[] parrBytes)
			throws BigBangJewelException
		{
			...
			larrProps = new PropertyValue[] {new PropertyValue(), new PropertyValue(), new PropertyValue()};
			larrProps[0].Name = "InputStream";
			larrProps[0].Value = lobjInp;
			larrProps[1].Name = "Hidden";
			larrProps[1].Value = new Boolean(true);
			larrProps[2].Name = "FilterName";
			larrProps[2].Value = "MS Word 97";
	...
	public static XTextDocument getODTFromBytes(byte[] parrBytes)
		throws BigBangJewelException
	{
		OOInputStream lobjInp;
		PropertyValue[] larrProps;
...
//					new ByteArrayInputStream(larrBytes));
	...
	public static FileXfer getDocFromOODoc(XTextDocument pobjDoc, String pstrFileName)
		throws BigBangJewelException
	{
		OOOutputStream lobjOut;
		PropertyValue[] larrProps;
		...
		try
		{
			...
			larrBytes = lobjOut.toByteArray();
			lobjResult = new FileXfer(larrBytes.length, "application/msword", pstrFileName, new ByteArrayInputStream(larrBytes));
		}
		catch (Throwable e)
		{
			throw new BigBangJewelException(e.getMessage(), e);
	...
	public static FileXfer getPDFFromOODoc(XTextDocument pobjDoc, String pstrFileName)
		throws BigBangJewelException
	{
		OOOutputStream lobjOut;
		PropertyValue[] larrProps;
