...
public class SubCasualtyHistoryReport
	extends SubCasualtyListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		larrResult[0] = buildHeaderSection("Histórico de Participações à Seguradora", larrAux, larrMap.size());
		...
		try
		{
			...
			lstrSQL.append("SELECT * FROM (")
					...
					.append(lrefLogs.SQLForSelectByMembers(
							...
							new java.lang.Object[] {Constants.OPID_SubCasualty_SendNotification, false},
							null))
