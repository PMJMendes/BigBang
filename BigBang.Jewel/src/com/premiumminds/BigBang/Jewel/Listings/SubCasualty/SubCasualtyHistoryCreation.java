...
public class SubCasualtyHistoryCreation
	extends SubCasualtyListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		larrResult[0] = buildHeaderSection("Histórico de Criação de Sub-Sinistros", larrAux, larrMap.size());
		...
		throws BigBangJewelException
	{
		...
		try
		{
			...
			lstrSQL.append("SELECT * FROM (")
					.append(lrefubCs.SQLForSelectAll()).append(") [AuxSubC] WHERE [Process] IN (SELECT [External Process] FROM(")
					.append(lrefLogs.SQLForSelectByMembers(
							...
							new java.lang.Object[] {Constants.OPID_Casualty_CreateSubCasualty, false},
							null))
