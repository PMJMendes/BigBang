...
public class SubCasualtyPendingReport
	extends SubCasualtyListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		larrResult[0] = buildHeaderSection("Sub-Sinistros Pendentes de Participação", larrAux, larrMap.size());
