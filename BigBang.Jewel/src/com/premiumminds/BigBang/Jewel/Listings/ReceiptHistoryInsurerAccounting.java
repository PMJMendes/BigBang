...
public class ReceiptHistoryInsurerAccounting
	extends ReceiptListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		larrResult[0] = buildHeaderSection("Histórico de Prestações de Contas", larrAux, larrMap.size());
		...
		try
		{
			...
			lstrSQL.append("SELECT * FROM (")
					...
					.append(lrefLogs.SQLForSelectByMembers(new int[] {Jewel.Petri.Constants.FKOperation_In_Log,
							Jewel.Petri.Constants.Undone_In_Log}, new java.lang.Object[] {Constants.OPID_Receipt_InsurerAccounting, false}, null))
