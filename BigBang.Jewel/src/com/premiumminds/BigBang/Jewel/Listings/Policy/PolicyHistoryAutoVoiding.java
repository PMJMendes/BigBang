...
public class PolicyHistoryAutoVoiding
	extends PolicyListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		larrResult[0] = buildHeaderSection("Histórico de Anulação Automática de Apólices", larrAux, larrMap.size());
		...
		try
		{
			...
			lstrSQL.append("SELECT * FROM (")
					...
					.append(lrefLogs.SQLForSelectByMembers(
							...
							new java.lang.Object[] {Constants.OPID_Policy_ExternAutoVoid, false},
							null))
