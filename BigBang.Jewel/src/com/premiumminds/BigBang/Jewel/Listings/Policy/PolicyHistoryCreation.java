...
public class PolicyHistoryCreation
	extends PolicyListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		larrResult[0] = buildHeaderSection("Histórico de Criação de Apólices", larrAux, larrMap.size());
		...
		throws BigBangJewelException
	{
		...
		try
		{
			...
			lstrSQL.append("SELECT * FROM (")
					.append(lrefPolicies.SQLForSelectAll()).append(") [AuxPol] WHERE [Process] IN (SELECT [External Process] FROM(")
