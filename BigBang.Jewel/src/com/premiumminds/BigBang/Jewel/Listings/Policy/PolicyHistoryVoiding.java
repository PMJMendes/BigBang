...
public class PolicyHistoryVoiding
	extends PolicyListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		larrResult[0] = buildHeaderSection("Histórico de Anulação de Apólices", larrAux, larrMap.size());
		...
		try
		{
			...
			lstrSQL.append("SELECT * FROM (")
					...
					.append(lrefLogs.SQLForSelectByMembers(
							...
							new java.lang.Object[] {Constants.OPID_Policy_VoidPolicy, false},
							null))
