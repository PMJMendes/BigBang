...
public class ReceiptHistorySendReceipt
	extends ReceiptListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		larrResult[0] = buildHeaderSection("Histórico de Envio de Recibos Pagos", larrAux, larrMap.size());
		...
		try
		{
			...
			lstrSQL.append("SELECT * FROM (")
					...
					.append(lrefLogs.SQLForSelectByMembers(new int[] {Jewel.Petri.Constants.FKOperation_In_Log,
							Jewel.Petri.Constants.Undone_In_Log}, new java.lang.Object[] {Constants.OPID_Receipt_SendReceipt, false}, null))
