...
public class ReceiptPendingSendPaymentNotice
	extends ReceiptListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		larrResult[0] = buildHeaderSection("Recibos Pendentes de Envio de Aviso de Cobrança", larrAux, larrMap.size());
		...
		throws BigBangJewelException
	{
		...
		try
		{
			...
			lstrSQL.append("SELECT * FROM (" +
					...
					new java.lang.Object[] {Constants.OPID_Receipt_CreatePaymentNotice, Constants.UrgID_Pending}, null) + ") [AuxSteps])");
		}
		catch (Throwable e)
		{
			throw new BigBangJewelException(e.getMessage(), e);
