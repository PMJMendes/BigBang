...
public class ReceiptHistoryPaymentForCasualties
	extends ReceiptListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		try
		{
			...
			lstrSQL.append("SELECT * FROM (")
					...
					.append("WHERE [Type] IN ('91E07F5F-56BA-4A65-9659-9F900111DF95', '4775B720-B90B-4279-B008-9F900111E6AD') ")
	...
	protected TD[] buildInnerHeaderRow()
	{
		...
		larrCells = super.buildInnerHeaderRow();

		larrCells[3] = ReportBuilder.buildHeaderCell("Sub-Sinistro");
			...
			throws BigBangJewelException
	{
		...
		lobjSubCasualty = pobjReceipt.getSubCasualty();
		larrCells = super.buildRow(pobjReceipt);
		...
		larrCells[3] = ReportBuilder.buildCell(lobjSubCasualty.getLabel(), TypeDefGUIDs.T_String);
