...
public class ReceiptPendingMediatorAccounting
	extends ReceiptListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		larrResult[0] = buildHeaderSection("Recibos Pendentes de Retrocessões", larrAux, larrMap.size());
		...
		throws BigBangJewelException
	{
		...
		try
		{
			...
			lstrSQL.append("SELECT * FROM (" +
					...
					new java.lang.Object[] {Constants.OPID_Receipt_MediatorAccounting, Constants.UrgID_Pending}, null) + ") [AuxSteps])");
		}
		catch (Throwable e)
		{
			throw new BigBangJewelException(e.getMessage(), e);
