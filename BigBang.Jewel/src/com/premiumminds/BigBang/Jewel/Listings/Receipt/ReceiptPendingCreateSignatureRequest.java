...
public class ReceiptPendingCreateSignatureRequest
	extends ReceiptListingsBase
{
		...
		throws BigBangJewelException
	{
		...
		larrResult[0] = buildHeaderSection("Recibos Pendentes de Criação de Pedido de Assinatura", larrAux, larrMap.size());
		...
		throws BigBangJewelException
	{
		...
		try
		{
			...
			lstrSQL.append("SELECT * FROM (" +
					...
					new java.lang.Object[] {Constants.OPID_Receipt_CreateSignatureRequest, Constants.UrgID_Pending}, null) + ") [AuxSteps])");
		}
		catch (Throwable e)
		{
			throw new BigBangJewelException(e.getMessage(), e);
