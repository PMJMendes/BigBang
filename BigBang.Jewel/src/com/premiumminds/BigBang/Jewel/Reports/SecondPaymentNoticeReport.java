...
public class SecondPaymentNoticeReport
	extends ReportBase
{
		...
		throws BigBangJewelException
	{
		...
		larrParams.put("UserMail", (String)UserDecoration.GetByUserID(Engine.getCurrentNameSpace(),
				Engine.getCurrentUser()).getAt(UserDecoration.I.EMAIL));
