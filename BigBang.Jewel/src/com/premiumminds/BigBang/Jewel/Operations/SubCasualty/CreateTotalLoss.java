	...
	extends Operation
{
	...
	public CreateTotalLoss(UUID pidProcess)
	{
		super(pidProcess);
	}
	...
	protected UUID OpID()
	{
		return Constants.OPID_SubCasualty_CreateTotalLoss;
	}

	public String ShortDesc()
	{
		return "Criação de Sub-Processo: Gestão de Perda Total";
	}
		...
		throws JewelPetriException
	{
		...
		try
		{
			...
			lobjAux = TotalLoss.GetInstance(Engine.getCurrentNameSpace(), (UUID)null);
