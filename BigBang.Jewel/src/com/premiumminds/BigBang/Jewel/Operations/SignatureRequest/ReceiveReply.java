...
import com.premiumminds.BigBang.Jewel.Operations.Receipt.ExternAllowSendPayment;

public class ReceiveReply
	extends /*Undoable*/Operation
{
...
//	private String mstrNewEmailID;
	...
	protected UUID OpID()
	{
		return Constants.OPID_SigReq_ReceiveReply;
	}
...
//		return lstrResult.toString();
		return "O cliente devolveu o recibo assinado.";
	}
...
//			mobjMessage.mobjDocOps.RunSubOp(pdb, GetProcess().GetParent().GetDataKey());
		...
		lopEASP = new ExternAllowSendPayment(GetProcess().GetParent().getKey());
		lopEASP.midSigRequestProc = GetProcess().getKey();
		TriggerOp(lopEASP, pdb);
