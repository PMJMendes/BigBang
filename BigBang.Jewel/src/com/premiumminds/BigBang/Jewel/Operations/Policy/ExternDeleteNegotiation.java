...
import com.premiumminds.BigBang.Jewel.Operations.Negotiation.ExternResumeNegotiation;

public class ExternDeleteNegotiation
	extends UndoableOperation
{
	...
	protected UUID OpID()
	{
		return Constants.OPID_Policy_ExternDeleteNegotiation;
	}

	public String ShortDesc()
	{
		return "Eliminação de Negociação";
	}
	...
	public String LongDesc(String pstrLineBreak)
	{
		...
		lstrResult.append("Foi eliminada a seguinte negociação:");
		...
		throws JewelPetriException
	{
		...
		try
		{
			lobjAux = Negotiation.GetInstance(Engine.getCurrentNameSpace(), midNegotiation);
			mobjData = new NegotiationData();
			...
			lobjAux.getDefinition().Delete(pdb, mobjData.mid);
		}
		catch (Throwable e)
		{
	...
	{
		return "A negociação apagada será reposta. O histórico de operações será recuperado.";
	}
	...
	public String UndoLongDesc(String pstrLineBreak) 
	{
		...
		lstrResult = new StringBuilder();
		lstrResult.append("Foi reposta a seguinte negociação:");
		lstrResult.append(pstrLineBreak);
		...
		throws JewelPetriException
	{
		Negotiation lobjAux;
		PNProcess lobjProcess;
		ExternResumeNegotiation lopERN;
	...
	public UndoSet[] GetSets()
	{
		...
		larrResult[0].midType = Constants.ObjID_Negotiation;
