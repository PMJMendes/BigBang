	...
	extends UndoableOperation
{
	...
	protected UUID OpID()
	{
		return Constants.OPID_Casualty_ManageData;
	}
	...
	public String LongDesc(String pstrLineBreak)
	{
		...
		if ( mobjData != null )
		{
			lstrResult.append("Novos dados de sinistro:");
		...
		throws JewelPetriException
	{
		...
		try
		{
			if ( mobjData != null )
			{
				...
				lobjAux = Casualty.GetInstance(Engine.getCurrentNameSpace(), mobjData.mid);
	...
	public UndoSet[] GetSets()
	{
		...
		if ( mobjData != null )
		{
			...
			larrResult[0].midType = Constants.ObjID_Casualty;
