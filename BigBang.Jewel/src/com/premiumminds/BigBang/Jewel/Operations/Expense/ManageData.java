	...
	extends UndoableOperation
{
	...
	protected UUID OpID()
	{
		return Constants.OPID_Expense_ManageData;
	}
	...
	public String LongDesc(String pstrLineBreak)
	{
		...
		if ( mobjData != null )
		{
			lstrResult.append("Novos dados da despesa:");
		...
		throws JewelPetriException
	{
		...
		try
		{
			if ( mobjData != null )
			{
				...
				lobjAux = Expense.GetInstance(Engine.getCurrentNameSpace(), mobjData.mid);

				mobjData.mobjPrevValues = new ExpenseData();
