	...
	extends UndoableOperation
{
	...
	protected UUID OpID()
	{
		return Constants.OPID_Assessment_ManageData;
	}
		...
		throws JewelPetriException
	{
		...
		try
		{
			if ( mobjData != null )
			{
				lobjAux = Assessment.GetInstance(Engine.getCurrentNameSpace(), mobjData.mid);

				mobjData.mobjPrevValues = new AssessmentData();
