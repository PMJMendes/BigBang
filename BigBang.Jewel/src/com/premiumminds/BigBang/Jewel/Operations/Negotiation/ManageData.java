	...
	extends UndoableOperation
{
	...
	protected UUID OpID()
	{
		return Constants.OPID_Negotiation_ManageData;
	}
	...
	public String LongDesc(String pstrLineBreak)
	{
		...
		if ( mobjData != null )
		{
			lstrResult.append("Novos dados da negociação:");
		...
		throws JewelPetriException
	{
		...
		try
		{
			if ( mobjData != null )
			{
				...
				lobjAux = Negotiation.GetInstance(Engine.getCurrentNameSpace(), mobjData.mid);

				mobjData.mobjPrevValues = new NegotiationData();
