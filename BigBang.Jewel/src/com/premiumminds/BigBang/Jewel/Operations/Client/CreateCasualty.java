	...
	extends Operation
{
	...
	public CreateCasualty(UUID pidProcess)
	{
		super(pidProcess);
	}
	...
	protected UUID OpID()
	{
		return Constants.OPID_Client_CreateCasualty;
	}

	public String ShortDesc()
	{
		return "Criação de Sinistro";
	}
	...
	public String LongDesc(String pstrLineBreak)
	{
		...
		lstrResult.append("Foi criado o seguinte sinistro:");
