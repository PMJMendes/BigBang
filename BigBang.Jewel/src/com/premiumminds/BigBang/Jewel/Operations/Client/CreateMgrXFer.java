	...
	extends UndoableOperation
{
	...
	{
		if ( mbDirectTransfer )
			return "Alteração do Gestor de Cliente";
	...
	public String LongDesc(String pstrLineBreak)
	{
		...
		if ( mbMassTransfer )
			lstrBuffer.append("Este cliente foi incluído num procedimento de transferência para um novo gestor.");
		else if ( mbDirectTransfer )
			lstrBuffer.append("Foi alterado o gestor deste cliente.");
		else
    	...
    	if ( !mbMassTransfer )
    	{
    		...
    		if ( midNewManager.equals(Engine.getCurrentUser()) )
    		{
	    		...
	    		try
	    		{
					...
					lobjItem.setAt(2, Constants.ProcID_Client);
	...
	public UndoSet[] GetSets()
	{
		...
		larrResult[0].marrChanged[0] = midClient;
