	...
	extends ProcessData
{
		...
		throws BigBangJewelException
	{
	    try
	    {
			return (Expense)Engine.GetWorkInstance(Engine.FindEntity(pidNameSpace, Constants.ObjID_Expense), pidKey);
		}
	    catch (Throwable e)
	    {
    ...
    public static Expense GetInstance(UUID pidNameSpace, ResultSet prsObject)
		throws BigBangJewelException
	{
	    try
	    {
			return (Expense)Engine.GetWorkInstance(Engine.FindEntity(pidNameSpace, Constants.ObjID_Expense), prsObject);
		}
	    catch (Throwable e)
	    {
	    	throw new BigBangJewelException(e.getMessage(), e);
    	...
    	throws BigBangJewelException
    {
		...
		larrParams[0] = Constants.ObjID_Expense;
		larrParams[1] = getKey();
