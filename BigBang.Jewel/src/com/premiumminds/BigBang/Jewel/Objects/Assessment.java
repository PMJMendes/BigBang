	...
	extends ProcessData
{
    ...
    public static Assessment GetInstance(UUID pidNameSpace, ResultSet prsObject)
		throws BigBangJewelException
	{
	    try
	    {
			return (Assessment)Engine.GetWorkInstance(Engine.FindEntity(pidNameSpace, Constants.ObjID_Assessment), prsObject);
		}
	    catch (Throwable e)
	    {
	    	throw new BigBangJewelException(e.getMessage(), e);
