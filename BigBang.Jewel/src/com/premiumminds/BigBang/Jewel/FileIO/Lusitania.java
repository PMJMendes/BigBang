...
public class Lusitania
	extends FileIOBase
{
	public static final UUID ObjID_TypeTranslator = UUID.fromString("AEEA0017-FA6E-425E-968C-A35300EFAE36");
	public static final UUID RDef_Imports = UUID.fromString("8D11763D-4B0B-44EF-8779-A0A701270881");
	public static final UUID FormatID_Lusitania = UUID.fromString("FCF86C3A-9F90-4D22-82C3-A35300EAB9EC");
	...
	public static class Fields
	{
		...
		public static final int SUBSUBLINE          =  2;
		public static final int POLICY              =  3;
		public static final int RECEIPT             =  4;
		public static final int CLIENTNAME          =  5;
		public static final int RECEIPTDESCRIPTION  =  6;
		public static final int ISSUEDATE           =  7;
		public static final int STARTDATE           =  8;
		public static final int ENDDATE             =  9;
		public static final int LIMITDATE           = 10;
		public static final int COMMERCIALPREMIUM   = 11;
		public static final int BONUS               = 12;
		public static final int COSTS               = 13;
		public static final int FGA                 = 14;
		public static final int POLICYCOSTS         = 15;
		public static final int CERTIFICATETESTS    = 16;
		public static final int INEM                = 17;
		public static final int SNB                 = 18;
		public static final int STAMPTAX            = 19;
		public static final int TOTALPREMIUM        = 20;
		public static final int CHARGECOMMISSION    = 21;
		public static final int MEDIATIONCOMMISSION = 22;
		public static final int BROKERAGECOMMISSION = 23;
		public static final int DIRECTDEBITINFO     = 24;
		public static final int AUTORCCAPITAL       = 25;
		public static final int AUTODPCAPITAL       = 26;
		public static final int RECEIPTCAPITAL      = 27;
	}
		...
		throws BigBangJewelException
	{
		...
		larrReceipts = mobjData.getData()[1];
		...
		try
		{
			createReport(ldb, "Importação Lusitania", RDef_Imports, FormatID_Lusitania.toString() + "|" + midSession.toString());
		}
		catch (BigBangJewelException e)
		{
			try { ldb.Disconnect(); } catch (SQLException e1) {}
		...
		throws BigBangJewelException
	{
		...
		try
		{
			...
			lidType = ProcessReceiptType(parrData[Fields.RECEIPTDESCRIPTION].getData());
			if ( lidType == null )
			{
			...
			ldblBonus = BuildDecimal(parrData[Fields.BONUS].getData());
			ldblCommercial = BuildDecimal(parrData[Fields.COMMERCIALPREMIUM].getData()).add(ldblBonus);
			ldblValue = BuildDecimal(parrData[Fields.TOTALPREMIUM].getData());
			ldblCommission = BuildDecimal(parrData[Fields.CHARGECOMMISSION].getData()).
					add(BuildDecimal(parrData[Fields.MEDIATIONCOMMISSION].getData())).
					add(BuildDecimal(parrData[Fields.BROKERAGECOMMISSION].getData()));
			...
			lopCR.mobjData.mdblBonusMalus = ldblBonus;
			lopCR.mobjData.mbIsMalus = ldblBonus.compareTo(BigDecimal.ZERO) < 0;
