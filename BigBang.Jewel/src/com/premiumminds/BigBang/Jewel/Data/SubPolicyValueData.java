...
public class SubPolicyValueData
	implements DataBridge
{
	...
	public SubPolicyValueData mobjPrevValues;

	public void Clone(SubPolicyValueData pobjSource)
	{
		mid = pobjSource.mid;
	...
	public void Describe(StringBuilder pstrBuilder, String pstrLineBreak)
	{
		...
		if ( midObject != null )
		{
			...
			try
			{
				lobjObject = SubPolicyObject.GetInstance(Engine.getCurrentNameSpace(), midObject);
