...
public class Constants
{
	...
	public static final UUID OPID_ExternEndClientMgrXFer            = UUID.fromString("77BB2541-4AA8-4980-BE98-9F8B01297CB6");
	public static final UUID OPID_ExternUndoEndClientMgrXFer        = UUID.fromString("AC843270-9D90-489A-A99B-9F8B0129C6AD");
	public static final UUID OPID_CreateQuoteRequest                = UUID.fromString("F9BF0190-20E3-45F8-9EBE-9F090142E605");
	public static final UUID OPID_ExternDeleteQuoteRequest          = UUID.fromString("68251204-CDAC-41CC-AADC-9F8B012A2274");
	public static final UUID OPID_UndoDeleteQuoteRequest            = UUID.fromString("AAA14707-B11F-42B6-BEF5-9F8B012B1424");
	public static final UUID OPID_CreatePolicy                      = UUID.fromString("5903FA18-8F4D-4DD3-B4AE-9F090143186E");
	public static final UUID OPID_ExternDeletePolicy                = UUID.fromString("8BFB93C8-2CCF-423F-9E35-9F8200CA7E06");
	public static final UUID OPID_UndoDeletePolicy                  = UUID.fromString("E5E66BC3-4B16-42F4-B653-9F8200CE2893");
	public static final UUID OPID_CreateClientRiskAnalysis          = UUID.fromString("AEC0C809-28EF-478D-B5B1-9F8B012E1757");
	public static final UUID OPID_ExternDeleteClientRiskAnalysis    = UUID.fromString("D301D131-D156-49EF-B727-9F8B012A49B7");
	public static final UUID OPID_UndoDeleteClientRiskAnalysis      = UUID.fromString("0BD92466-BCEB-4854-BF84-9F8B012AF683");
	public static final UUID OPID_CreateCasualty                    = UUID.fromString("6CCF24EB-AF80-4B63-A50A-9F8B012E01BB");
	...
	public static final UUID OPID_PerformComputations               = UUID.fromString("7DC1A798-31AA-49A1-B2DC-9FD4010F7593");
	...
	public static final UUID OPID_OpenNewExercise                   = UUID.fromString("C86BB300-28C1-47EF-A48D-9FD4010F9149");
	public static final UUID OPID_UndoOpenExercise                  = UUID.fromString("D7CB22BA-C37D-40DD-948B-9FD4010FAA85");
	public static final UUID OPID_IncludePolicyObject               = UUID.fromString("984226BB-33EA-4988-A802-9FD4010FC200");
	public static final UUID OPID_IncludeClientAsPolicyObject       = UUID.fromString("783EFBDB-44DB-4CAA-BF88-9FD4010FDB91");
	public static final UUID OPID_UndoIncludeObject                 = UUID.fromString("6C57D11D-6E56-405B-AACE-9FD4010FF6F5");
	public static final UUID OPID_ExcludeObject                     = UUID.fromString("CB5A1425-C032-4678-B9B2-9FD401149CB8");
	public static final UUID OPID_UndoExcludeObject                 = UUID.fromString("6B10D212-CE69-4E02-9078-9FD40114D696");
	public static final UUID OPID_CreatePolicyDebitNote             = UUID.fromString("4CC51237-FC83-4B13-A8A9-9FD401100FE2");
	public static final UUID OPID_UndoPolicyDebitNote               = UUID.fromString("16C44D7D-6D09-4957-9051-9FD40110291E");
	public static final UUID OPID_ExternDisallowUndoPolicyDebitNote = UUID.fromString("1E90FD94-1C63-4984-AB2E-9FD401105E35");
	public static final UUID OPID_CreateRecurringInfoProcess        = UUID.fromString("5A89B28E-3098-490F-8AD0-9FD401109F6D");
	public static final UUID OPID_CreatePolicyInfoRequest           = UUID.fromString("DF06C139-4D61-44D1-81EE-9FD30118E9D3");
	public static final UUID OPID_CreatePolicyCompInfoRequest       = UUID.fromString("3F0120C1-F64E-4806-8AB2-9FD40110D264");
	...
	public static final UUID OPID_CreateSubPolicy                   = UUID.fromString("DF27A2DA-1B36-4F1C-B242-9FD40110F495");
	public static final UUID OPID_ExternDeleteSubPolicy             = UUID.fromString("99831C5E-E137-4B5E-B18D-9FD401111B36");
	public static final UUID OPID_UndoDeleteSubPolicy               = UUID.fromString("41F07FC7-51A1-4B62-A37C-9FD4011138CA");
	public static final UUID OPID_CreateNegotiation                 = UUID.fromString("852BF3BF-F04A-494D-A308-9FD4011152C4");
	public static final UUID OPID_ExternDeleteNegotiation           = UUID.fromString("5EFE2E2E-6B7B-43B4-8970-9FD4011166E9");
	public static final UUID OPID_UndoDeleteNegotiation             = UUID.fromString("CA6217B8-34C8-49E4-ADB7-9FD401117C22");
	public static final UUID OPID_CreateRiskAnalysis                = UUID.fromString("731AAB07-BBE4-4BA2-8A37-9FD40111E7EA");
	public static final UUID OPID_ExternDeleteRiskAnalysis          = UUID.fromString("54284976-C57C-4485-85E8-9FD401120237");
	public static final UUID OPID_UndoDeleteRiskAnalysis            = UUID.fromString("643F0129-F12B-4205-BFE7-9FD40112B6E7");
	public static final UUID OPID_CreateHealthExpense               = UUID.fromString("A7A22C6D-ED66-444D-9E5E-9FD40112D52C");
	public static final UUID OPID_ExternDeleteHealthExpense         = UUID.fromString("C0DAB4FC-A8CE-4D48-A31D-9FD40112FC86");
	public static final UUID OPID_UndoDeleteHealthExpense           = UUID.fromString("8979C0F8-09BF-4397-BA9E-9FD401131CF8");
	public static final UUID OPID_PolicySubstitution                = UUID.fromString("66504952-BCFD-4B6A-B8F0-9FD401138D07");
	public static final UUID OPID_UndoPolicySubstitution            = UUID.fromString("F51B633C-C6C2-46D6-A1B3-9FD40113ADFB");
	public static final UUID OPID_MediationTransfer                 = UUID.fromString("9568FAA4-ADBF-41AE-8FB9-9FD401140765");
	public static final UUID OPID_UndoMediationTransfer             = UUID.fromString("D663E77C-D7FD-440E-B0FE-9FD4011422B6");
	public static final UUID OPID_VoidPolicy                        = UUID.fromString("DF2C50EF-5E4A-475A-AB1E-9FD401143D8A");
	public static final UUID OPID_UndoVoidPolicy                    = UUID.fromString("3C1FD4F4-4100-4A22-A88C-9FD401145205");
