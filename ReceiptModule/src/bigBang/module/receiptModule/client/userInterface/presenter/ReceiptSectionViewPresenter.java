...
import bigBang.module.receiptModule.client.ReceiptSection;

public class ReceiptSectionViewPresenter implements SectionViewPresenter {
	...
	private ReceiptSection receiptSection;
	...
	public ReceiptSectionViewPresenter(EventBus eventBus, Service service, View view) {
	...
	public void setSection(MenuSection s) {
		this.receiptSection = (ReceiptSection) s;
		OperationViewPresenter[] operationPresenters = this.receiptSection.getOperationPresenters();
